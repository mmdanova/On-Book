        ...
        <div class="container-fluid bg-light" style="margin-top: 50px">
          <div class="row">
            ...
            <div class="col-6">
              <div class="card">
                  <div class="card-body">
                      <h5 class="card-title" id="idNomeUsuario">Nome Usuário</h5>
                      <div>
                        ...
                        <label><b>Tipo de Usuário: </b></label><label id="idTipoUsuario">Estudante</label><br>
                        <label><b>Endereço: </b></label><p id="idEnderecoUsuario">Endereço</p>
                      </div>
