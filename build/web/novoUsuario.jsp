    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        <nav class="navbar bg-dark">
          <h4 style="color: white">Novo Cadastro</h4>
        </nav>
          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="form-group">
                <input type="text" class="form-control" id="txtNomeUsuario" placeholder="Nome do Usuário">
              </div>
              ...
              <div class="form-group">
                <input type="email" class="form-control" id="txtEmailUsuario" placeholder="name@example.com">
              </div>
