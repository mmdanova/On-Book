              ...
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    ...
                    <div class="row">
                      <div class="col">
                        <label><b>Biblioteca: </b></label><p id="idNomeBiblioteca">Biblioteca Municipal de São José</p>
                        <label><b>Localização: </b></label><p id="idLocalizacao">R. Padre Macário, 10 - Centro, São José - SC, 88103-020</p>                      
                      </div>
                    </div>
                  </div>
                  <div class="col">
                ...
                <div class="form-group float-right">
                  <button type="submit" id="btnEmprestimo" class="btn btn-primary" style="margin: 20px">Finalizar Empréstimo</button>
                </div>
              </div>
            </div>
          </div>
